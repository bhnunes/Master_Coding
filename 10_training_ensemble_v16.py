# -*- coding: utf-8 -*-
"""9_Training_ensemble_v11_v4_full.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1A1EQEngyFoJlJzNs6mOm4e7kkBuy31lS
...
!pip install aim pyngrok albumentations schedulefree torchinfo torchmetrics h5py
...
```
while sleep 30; do echo "==== $(date) ===="; echo "RAM:"; free -h | awk '/Mem:/ {print $3 "/" $2}'; echo "Disk:"; df -h / | awk 'NR==2 {print $3 "/" $2}'; echo "GPU:"; nvidia-smi --query-gpu=memory.used,memory.total --format=csv,noheader; echo; done
