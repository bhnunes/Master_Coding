...
**IMPORTANT: Always ask the user what password they want before encrypting any PDF. Use the current user-input tool if one is available; otherwise ask directly. Never use a default or auto-generated password. The user must explicitly choose their password.**
...
1. Ask: "What password would you like to use to protect this PDF?"
