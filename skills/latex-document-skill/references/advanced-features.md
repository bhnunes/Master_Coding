...
| AI-generated images | imagegen skill/tool | Custom illustrations, diagrams, photos |
...
When image generation is available, create custom illustrations for LaTeX documents with the current environment's image-generation tool or skill, save the result as a normal image file, and include that file in the document.

### Workflow

1. Generate the image with the available image-generation tool and save it to `./outputs/neural_net.png`.
