...
**Step A: Ask for cheat sheet type**:
...
**Step B: Ask about source material**:
...
- A large context window can often fit about 150-200 pages of extracted text
- For documents up to about 150 pages: can often fit entire extracted text in one pass
- For 150-300 pages: two-pass (first half to extract, second half to extract, then merge)
