...
# Validate input before dependency checks so missing-file errors stay clear even
# when optional Graphviz binaries are unavailable.
...
ensure_graphviz_available || exit 1
