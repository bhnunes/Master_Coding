...
OPTIMAL_PARAMS = {
    ...
    'erosion_px': 0,
    'contamination_rate_thresh': 0.24  # This is our decision boundary 'tau'
}
...
if __name__ == "__main__":
    ...
    SOURCE_IMAGE_DIR = r"D:\Usuario\Desktop\Base_de_dados\CAMELYON16\PATCHES_TEST\CANCER"
    SOURCE_IMAGE_DIR = os.path.normpath(SOURCE_IMAGE_DIR)
    SOURCE_MASK_DIR = r"D:\Usuario\Desktop\Base_de_dados\CAMELYON16\PATCHES_TEST\CANCER_MASK"
    SOURCE_MASK_DIR = os.path.normpath(SOURCE_MASK_DIR)

    # This is the base directory where rejected files will be placed.
    OUTPUT_DIR = r"D:\Usuario\Desktop\Base_de_dados\CAMELYON16\PATCHES_TEST"
