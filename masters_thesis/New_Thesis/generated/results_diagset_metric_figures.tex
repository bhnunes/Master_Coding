...
\caption{Metricas micro/pixel-level no conjunto de teste de DIAGSET. Cada painel mostra uma metrica; os pontos representam as normalizacoes e as barras verticais indicam IC95\%.}
...
\caption{Metricas macro/patient-level no conjunto de teste de DIAGSET. Cada painel resume uma metrica por normalizacao, com barras verticais representando IC95\%.}
...
\end{subfigure}
\caption{Metricas Rule-6 no conjunto de teste de DIAGSET. O painel esquerdo mostra o Dice em pacientes positivos, e o painel direito mostra a taxa limpa em pacientes negativos; as barras verticais indicam IC95\%.}
